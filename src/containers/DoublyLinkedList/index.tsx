...
import { default as LinkedList } from '../../lib/LinkedList/DoublyLinkedList';
...
const DoublyLinkedList = () => {
  ...
  const addFirst = (): void => {
    ...
    linkedList.addFirst(new Node({ value: parseInt(value, 10), next: null, previous: null }));
    resetState();
  }
  ...
  const addLast = (): void => {
    ...
    linkedList.addLast(new Node({ value: parseInt(value, 10), next: null, previous: null }));
    resetState();
  }
  ...
  const add = (): void => {
    ...
    linkedList.add(new Node({ value: parseInt(value, 10), next: null, previous: null }), parseInt(index, 10));
    resetState();
  }
  ...
  const switchContent = (): ReactNode => {
    ...
    switch (selectedTab) {
      ...
      default:
        return (
          <>
            <h2 style={{ marginBottom: 20 }}>Doubly Linked List</h2>
